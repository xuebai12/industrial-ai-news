...
def scrape_web_sources(max_items: int = 20) -> list[Article]:
    ...
    selectors = {
        ...
        "Automobilwoche": "article a, .teaser a, .news-item a, a[href*='/artikel/']",
        "VDA News": "article a, .news-item a, .teaser a, a[href*='/presse/']",
        "Infineon News": "article a, .press-item a, .news-item a, a[href*='/press/']",
        "STMicroelectronics Newsroom": "article a, .news-item a, .tile a, a[href*='/']",
        "NXP Newsroom": "article a, .news-item a, .cmp-teaser a, a[href*='/news/']",
        "SemiEngineering": "article a, .post a, .entry a, a[href*='/']",
        "EE Times": "article a, .news-item a, .teaser a, a[href*='/']",
        "Estun Robotics News": "article a, .news-list a, .list-item a, a[href*='/']",
        "Siasun News": "article a, .news-list a, .list-item a, a[href*='catid=']",
        "Inovance News": "article a, .news-item a, .list-item a, a[href*='/news/']",
        "Hikrobot News": "article a, .news-item a, .list-item a, a[href*='/news']",
        "Robot-Forum China News": "article a, .news-item a, .post a, a[href*='/']",
        "Siemens Software Blog (R&D)": "article a, .post a, .entry a, a[href*='/blog/']",
        "ANSYS Blog (Industrial R&D)": "article a, .blog-card a, .post a, a[href*='/blog/']",
        "Manufacturing Digital": "article a, .article-card a, .story a, a[href*='/']",
        "Factory Automation (Automation.com)": "article a, .article a, .teaser a, a[href*='/articles/']",
        "Cognex Blog": "article a, .post a, .blog-item a, a[href*='/blogs/']",
        "Keyence News": "article a, .news-item a, .list-item a, a[href*='/news/']",
        "Augury Blog": "article a, .post a, .entry a, a[href*='/blog/']",
        "Fluke Reliability Blog": "article a, .post a, .entry a, a[href*='/blog/']",
        "IFR Press Releases": "article a, .press-item a, .news-item a, a[href*='/ifr-press-releases/']",
        "The Robot Report": "article a, .post a, .entry a, a[href*='/']",
        "Automotive World": "article a, .news-item a, .list-item a, a[href*='/news-releases/']",
        "SupplyChainBrain": "article a, .post a, .entry a, a[href*='/']",
        "Logistics Management": "article a, .news-item a, .teaser a, a[href*='/']",
        "Energy Storage News": "article a, .news-item a, .post a, a[href*='/']",
        "pv magazine Industry": "article a, .post a, .entry a, a[href*='/']",
        "CISA ICS Advisories": "article a, .usa-card a, .list-item a, a[href*='/cybersecurity-advisories']",
        "Nozomi Networks Blog": "article a, .post a, .entry a, a[href*='/blog']",
        "Dragos Blog": "article a, .post a, .entry a, a[href*='/blog/']",
    }
